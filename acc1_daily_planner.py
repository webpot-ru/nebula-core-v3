...
def build_daily_plan(
    ...
    *,
    ...
    # The visual identity is selected by the canonical thematic pilot, never
    # by a loose render-time default.  The selected profile contains a wider
    # deterministic layout repertoire, so subsequent stories do not reuse a
