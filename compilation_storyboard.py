...
def _verified_editorial_assets(
    ...
    for source in story.get("generated_media") or []:
        ...
        assets.append({
            ...
            "story_family": str(source.get("story_family") or ""),
            "page_layout": str(source.get("page_layout") or ""),
            "panel_grammar": str(source.get("panel_grammar") or ""),
            "panel_count": source.get("panel_count"),
            "panel_beat_role": str(source.get("panel_beat_role") or ""),
